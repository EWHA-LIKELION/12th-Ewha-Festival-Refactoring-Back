    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='booth_scrap', to='accounts.user')),
            ],
        ),
        migrations.CreateModel(
            name='Guestbook',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='guestbook', to='accounts.user')),
            ],
        ),
        migrations.CreateModel(
            name='Menu_scrap',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='menu_scrap', to='accounts.user')),
            ],
        ),
        migrations.CreateModel(
            name='Reply',
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reply', to='accounts.user')),
            ],
        ),
    ]
